...
- **Repo**: `github.com/blerbz/grunt` (setup in progress, see BLE-309)
- **Startup command**: `grunt work`
- **Stack**: TBD (define as part of v0.1 planning)
